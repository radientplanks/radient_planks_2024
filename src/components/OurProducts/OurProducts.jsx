...
const OurProducts = () => {
  ...
  return (
    ...
    <div className='flex md:flex-row flex-col  gap-4 xl:w-[85%] w-[90%] h-fit md:h-[626px] mt-10 '>
        <Link to="/collection/eco" onClick={()=>handleLinkClick()} className='md:w-[50%] w-full md:h-full h-[250px] relative group '>
        ...
        <Link to="/collection/luxicore" onClick={()=>handleLinkClick()} className='w-[100%] md:h-[48.5%] h-[250px] relative group '>
        ...
        <Link to="/collection/viva" onClick={()=>handleLinkClick()} className='w-[100%] md:h-[49%] h-[250px] relative group '>
            <div className='absolute  left-6 bottom-4   '>
