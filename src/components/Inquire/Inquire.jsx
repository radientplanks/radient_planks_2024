       ...
       <div className='absolute flex justify-center xl:justify-end xl:pr-20 w-full h-full items-center  '>
        <div className=' w-[90%]  md:w-[461px] h-fit bg-white pb-3 rounded-[20px]  '>
           ...
           <form onSubmit={onSubmit} ref={contactRef} className='w-[90%] mx-auto mt-7 flex flex-col gap-y-5 '>
             <input placeholder='Enter Your Name' type='text' name="name" required className='w-full h-[45px] rounded-[10px] outline-none focus:outline-[#F29622] duration-500 transition-all placeholder:text-[#535353] placeholder:text-[13px] placeholder:font-workSans px-4 bg-[#F4F5F5]  ' />
             <input placeholder='Company Name' type='text' name="companyName" required className='w-full h-[45px] rounded-[10px] outline-none focus:outline-[#F29622] duration-500 transition-all placeholder:text-[#535353] placeholder:text-[13px] placeholder:font-workSans px-4 bg-[#F4F5F5]  ' />
             <input placeholder='Email' type='email' name="email" required className='w-full h-[45px] rounded-[10px] outline-none focus:outline-[#F29622] duration-500 transition-all placeholder:text-[#535353] placeholder:text-[13px] placeholder:font-workSans px-4 bg-[#F4F5F5]  ' />
             <input placeholder='Phone' type='number' name="phone" required className='w-full h-[45px] rounded-[10px] outline-none focus:outline-[#F29622] duration-500 transition-all placeholder:text-[#535353] placeholder:text-[13px] placeholder:font-workSans px-4 bg-[#F4F5F5]  ' />
             ...
             <button className='w-full h-[50px] rounded-[14px] mt-1 bg-black text-white font-montserrat font-semibold text-[16px] ' >Submit</button>
           </form>
